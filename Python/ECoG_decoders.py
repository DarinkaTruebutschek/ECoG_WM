...
#MNE
from mne.decoding import (get_coef, SlidingEstimator, GeneralizingEstimator, cross_val_multiscore, LinearModel)
...
def linModel(data_train, label_train, data_test, label_test, generalization=False, n_folds=5, predict_mode='cross-validation', scoring=None):
	"""
	This function performs a linear discriminant analysis.
	"""
	...
	#Pipeline
	clf = make_pipeline(scaler, LinearModel(model))
	...
	return time_gen, y_pred_all, test_index_all, scores, coefs
