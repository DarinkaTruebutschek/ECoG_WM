...
for subi = 1 : length(subnips)
    ...
    no_rule{subi} = ECoG_getTrialCount([data_mem.cue, data_mem.EEG_included, data_mem.timing], 'rule'); %get # of trials per rule condition
    no_load{subi} = ECoG_getTrialCount([data_mem.load, data_mem.EEG_included, data_mem.timing], 'load'); %get # of trials per load condition
    no_stimID{subi} = ECoG_getTrialCount([data_mem.stimA_id, data_mem.stimB_id, data_mem.stimC_id, data_mem.stimD_id, data_mem.EEG_included, data_mem.timing], 'stimID'); %get # of trials a given stimulus ID was shown (collapsed across load)
    no_rule_stimID{subi} = ECoG_getTrialCount([data_mem.cue, data_mem.stimA_id, data_mem.stimB_id, data_mem.stimC_id, data_mem.stimD_id, data_mem.EEG_included, data_mem.timing], 'rule_stimID'); %get # of trials a given stimulus ID was shown per rule condition
