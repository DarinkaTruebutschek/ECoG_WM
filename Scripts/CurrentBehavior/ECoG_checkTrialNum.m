...
for subi = 1 : length(subnips)
    ...
    %Add accuracy of response
    acc = [];
    for triali = 1 : length(data_mem.trial_id)
        if (data_mem.resp(triali) == 1) | (data_mem.resp(triali) == 3)
            acc(triali) = 1;
        elseif (data_mem.resp(triali) == 2) | (data_mem.resp(triali) == 4)
            acc(triali) = 0;
        else
            acc(triali) = nan;
        end
    ...
    num_cueMatch_load1_item1(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 0 & (data_mem.stimA_id == 1 | data_mem.stimB_id == 1 | ...
        data_mem.stimC_id == 1 | data_mem.stimD_id == 1)); 
    num_cueMatch_load1_item2(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 0 & (data_mem.stimA_id == 2 | data_mem.stimB_id == 2 | ...
        data_mem.stimC_id == 2 | data_mem.stimD_id == 2)); 
    num_cueMatch_load1_item3(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 0 & (data_mem.stimA_id == 3 | data_mem.stimB_id == 3 | ...
        data_mem.stimC_id == 3 | data_mem.stimD_id == 3)); 
    num_cueMatch_load1_item4(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 0 & (data_mem.stimA_id == 4 | data_mem.stimB_id == 4 | ...
        data_mem.stimC_id == 4 | data_mem.stimD_id == 4)); 
    num_cueMatch_load1_item5(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 0 & (data_mem.stimA_id == 5 | data_mem.stimB_id == 5 | ...
        data_mem.stimC_id == 5 | data_mem.stimD_id == 5)); 
    num_cueMatch_load1_item6(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 0 & (data_mem.stimA_id == 6 | data_mem.stimB_id == 6 | ...
        data_mem.stimC_id == 6 | data_mem.stimD_id == 6)); 
    num_cueMatch_load1_item7(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 0 & (data_mem.stimA_id == 7 | data_mem.stimB_id == 7 | ...
        data_mem.stimC_id == 7 | data_mem.stimD_id == 7)); 
    num_cueMatch_load1_item8(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 0 & (data_mem.stimA_id == 8 | data_mem.stimB_id == 8 | ...
        data_mem.stimC_id == 8 | data_mem.stimD_id == 8)); 
    num_cueMatch_load1_item9(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 0 & (data_mem.stimA_id == 9 | data_mem.stimB_id == 9 | ...
        data_mem.stimC_id == 9 | data_mem.stimD_id == 9)); 
    num_cueMatch_load1_item10(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 0 & (data_mem.stimA_id == 1 | data_mem.stimB_id == 1 | ...
        data_mem.stimC_id == 1 | data_mem.stimD_id == 1)); 
    
    num_cueMismatch_load1_item1(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 1 & (data_mem.stimA_id == 1 | data_mem.stimB_id == 1 | ...
        data_mem.stimC_id == 1 | data_mem.stimD_id == 1)); 
    num_cueMismatch_load1_item2(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 1 & (data_mem.stimA_id == 2 | data_mem.stimB_id == 2 | ...
        data_mem.stimC_id == 2 | data_mem.stimD_id == 2)); 
    num_cueMismatch_load1_item3(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 1 & (data_mem.stimA_id == 3 | data_mem.stimB_id == 3 | ...
        data_mem.stimC_id == 3 | data_mem.stimD_id == 3)); 
    num_cueMismatch_load1_item4(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 1 & (data_mem.stimA_id == 4 | data_mem.stimB_id == 4 | ...
        data_mem.stimC_id == 4 | data_mem.stimD_id == 4)); 
    num_cueMismatch_load1_item5(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 1 & (data_mem.stimA_id == 5 | data_mem.stimB_id == 5 | ...
        data_mem.stimC_id == 5 | data_mem.stimD_id == 5)); 
    num_cueMismatch_load1_item6(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 1 & (data_mem.stimA_id == 6 | data_mem.stimB_id == 6 | ...
        data_mem.stimC_id == 6 | data_mem.stimD_id == 6)); 
    num_cueMismatch_load1_item7(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 1 & (data_mem.stimA_id == 7 | data_mem.stimB_id == 7 | ...
        data_mem.stimC_id == 7 | data_mem.stimD_id == 7)); 
    num_cueMismatch_load1_item8(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 1 & (data_mem.stimA_id == 8 | data_mem.stimB_id == 8 | ...
        data_mem.stimC_id == 8 | data_mem.stimD_id == 8)); 
    num_cueMismatch_load1_item9(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 1 & (data_mem.stimA_id == 9 | data_mem.stimB_id == 9 | ...
        data_mem.stimC_id == 9 | data_mem.stimD_id == 9)); 
    num_cueMismatch_load1_item10(subi) = sum(data_mem.EEG_included & data_mem.acc & data_mem.load == 1 & data_mem.cue == 1 & (data_mem.stimA_id == 0 | data_mem.stimB_id == 0 | ...
        data_mem.stimC_id == 0 | data_mem.stimD_id == 0)); 
end